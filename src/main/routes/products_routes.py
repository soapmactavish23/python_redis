...
from src.main.composer.product_creator_composer import product_create_composer
from src.main.composer.product_finder_composer import product_finder_composer

products_routes_bp = Blueprint('products_routes_bp', __name__)

@products_routes_bp.route('/products', methods=['POST'])
def insert_product():
    http_request = HttpRequest(body=request.json)
    product_creator = product_create_composer()
